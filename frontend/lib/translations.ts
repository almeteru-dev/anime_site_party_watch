...
const uk: typeof en = {
	...
	catalog: {
		...
		title: "Каталог аніме",
		subtitle:
			"Відкрийте для себе нове улюблене аніме з нашої колекції. Використовуйте фільтри, щоб швидко знайти те, що вам потрібно.",
		...
		filters: {
			...
			reset: "Скинути",
			tip:
				"Порада: вибір фільтрів Студія/Джерело/Рейтинг (або сортування за ними) приховує порожні значення.",
			genres: "Жанри",
			themes: "Теми",
			status: "Статус",
			year: "Рік",
			to: "до",
			releaseDateUnknown: "Дата релізу невідома",
			type: "Тип",
			sort: "Сортування",
			sortBy: "Сортувати за",
			direction: "Напрям",
	...
	schedule: {
		...ru.schedule,
		title: "Розклад релізів",
		subtitle: "Стежте за новими епізодами й не пропускайте улюблене аніме.",
		timezone: "Часовий пояс",
		today: "СЬОГОДНІ",
		failedToLoad: "Не вдалося завантажити розклад",
		noReleasesTitle: "Немає релізів",
		noReleasesSubtitle: "На цей день вихід аніме не заплановано",
	},
	anime: {
		...ru.anime,
	...
	footer: {
		...ru.footer,
		tagline: "Ваш шлях до безкінечних аніме-пригод",
		...
		disclaimer: "LycorisLib не зберігає файли на своїх серверах. Увесь контент надається сторонніми джерелами.",
	},
	faqPage: {
		...ru.faqPage,
		subtitle: "Відповіді на популярні запитання про сайт.",
		empty: "Поки що немає опублікованих запитань.",
		back: "Назад",
	},
	profile: {
		...ru.profile,
		...
		accessDeniedBody: "Будь ласка, увійдіть, щоб переглянути профіль.",
		goHome: "На головну",
		backToHome: "На головну",
		failedToLoadProfile: "Не вдалося завантажити профіль",
		ageUpdated: "Вік успішно оновлено!",
		...
		changeEmailButton: "Змінити Email",
		verifyCodeButton: "Перевірити код",
		getCodeButton: "Отримати код",
		confirmChangeButton: "Підтвердити",
		animeWatched: "Переглянуто",
		totalInList: "Усього у списку",
		collections: "Мої колекції",
		watched: "Переглянуто",
		planned: "Заплановано",
		allAnime: "Усі аніме",
		viewCards: "Картки",
		viewTable: "Таблиця",
		importFromShikimori: "Імпортувати аніме з Shikimori",
		exportToJson: "Експорт JSON",
		clearLists: "Очистити списки",
		clearing: "Очищення…",
		shikimoriUsername: "Нік на Shikimori",
		importExistingLabel: "Якщо аніме вже у списку",
		importReplace: "Замінювати",
		importSkip: "Не замінювати",
		importingShikimori: "Імпорт…",
		importingJson: "Імпорт…",
		listSignInTitle: "Увійдіть, щоб побачити список",
		listSignInBody: "Ваш список прив’язаний до акаунта.",
		listEmptyTitle: "Ваш список порожній",
		listEmptyBody: "Додайте аніме з каталогу, щоб вони з’явилися тут.",
		listBrowseCatalog: "Відкрити каталог",
		listEmptyTab: "У цій колекції немає елементів.",
	...
	status: {
		...
		confirmRemove: "Видалити це аніме?",
		confirmRemoveDesc: "Аніме буде видалено з вашої колекції.",
		yes: "Так, видалити",
		no: "Скасувати",
		statusChanged: "Статус змінено на",
		removed: "Видалено з вашого списку",
	},
	language: {
		...ru.language,
		ru: "Російська",
...
export const translations = { en, ru, uk } as const
