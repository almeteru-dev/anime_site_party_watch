...
func main() {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/public/mal/anime/search", handlers.PublicMALAnimeSearch)
		api.GET("/public/mal/anime/:id", handlers.PublicMALAnimeDetails)
		...
		protected.Use(middleware.AuthMiddleware())
		{
			...
			admin.Use(middleware.DenyModeratorDelete())
			{
				...
				admin.POST("/animes/:id/moonanime/import", handlers.AdminMoonanimeImportEpisodes)
				...
				admin.GET("/moonanime/animes/:id", handlers.AdminMoonanimeGetAnime)

				// Admin/root-only: dictionaries, users, settings
				adminAdmin := admin.Group("")
				adminAdmin.Use(middleware.AdminOnly())
				{
					adminAdmin.POST("/watch-party/purge-offline", watchPartyHub.AdminPurgeOfflineRooms)
					...
					adminAdmin.GET("/users/by-username/:username", middleware.RootOnly(), handlers.AdminGetUserProfileByUsername)
					...
					adminAdmin.GET("/achievements", middleware.RootOnly(), handlers.AdminListAchievements)
					adminAdmin.POST("/achievements", middleware.RootOnly(), handlers.AdminCreateAchievement)
					adminAdmin.PUT("/achievements/:id", middleware.RootOnly(), handlers.AdminUpdateAchievement)
					adminAdmin.DELETE("/achievements/:id", middleware.RootOnly(), handlers.AdminDeleteAchievement)
					adminAdmin.POST("/achievements/:id/assign-by-role", middleware.RootOnly(), handlers.AdminBulkAssignAchievementByRole)
					adminAdmin.POST("/achievements/:id/assign-by-registered-before", middleware.RootOnly(), handlers.AdminBulkAssignAchievementByRegisteredBefore)
					adminAdmin.POST("/achievements/:id/unassign-by-role", middleware.RootOnly(), handlers.AdminBulkUnassignAchievementByRole)
					adminAdmin.GET("/users/:id/achievements", middleware.RootOnly(), handlers.AdminGetUserAchievements)
					adminAdmin.POST("/users/:id/achievements", middleware.RootOnly(), handlers.AdminAssignAchievementToUser)
					adminAdmin.DELETE("/users/:id/achievements/:achievementId", middleware.RootOnly(), handlers.AdminUnassignAchievementFromUser)

					adminAdmin.GET("/titles", middleware.RootOnly(), handlers.AdminListTitles)
					adminAdmin.POST("/titles", middleware.RootOnly(), handlers.AdminCreateTitle)
					adminAdmin.PUT("/titles/:id", middleware.RootOnly(), handlers.AdminUpdateTitle)
					adminAdmin.DELETE("/titles/:id", middleware.RootOnly(), handlers.AdminDeleteTitle)
					adminAdmin.POST("/titles/:id/assign-by-role", middleware.RootOnly(), handlers.AdminBulkAssignTitleByRole)
					adminAdmin.POST("/titles/:id/assign-by-registered-before", middleware.RootOnly(), handlers.AdminBulkAssignTitleByRegisteredBefore)
					adminAdmin.POST("/titles/:id/unassign-by-role", middleware.RootOnly(), handlers.AdminBulkUnassignTitleByRole)
					adminAdmin.GET("/users/:id/titles", middleware.RootOnly(), handlers.AdminGetUserTitles)
					adminAdmin.POST("/users/:id/titles", middleware.RootOnly(), handlers.AdminAssignTitleToUser)
					adminAdmin.DELETE("/users/:id/titles/:titleId", middleware.RootOnly(), handlers.AdminUnassignTitleFromUser)

					adminAdmin.PUT("/settings/default-password", middleware.RootOnly(), handlers.AdminSetDefaultPassword)
					adminAdmin.GET("/rules", middleware.RootOnly(), handlers.ListRules)
					adminAdmin.POST("/rules", middleware.RootOnly(), handlers.AdminCreateRule)
					adminAdmin.PUT("/rules/:id", middleware.RootOnly(), handlers.AdminUpdateRule)
					adminAdmin.DELETE("/rules/:id", middleware.RootOnly(), handlers.AdminDeleteRule)
					...
					adminAdmin.POST("/moonanime/bulk/start", middleware.RootOnly(), handlers.AdminMoonanimeBulkStart)
					adminAdmin.GET("/moonanime/bulk/status", middleware.RootOnly(), handlers.AdminMoonanimeBulkStatus)
					...
					adminAdmin.GET("/mal/oauth/start", handlers.AdminMALOAuthStart)
					adminAdmin.GET("/mal/oauth/callback", handlers.AdminMALOAuthCallback)
					adminAdmin.GET("/mal/tokens", handlers.AdminMALTokenStatus)
					adminAdmin.POST("/mal/tokens/refresh", handlers.AdminMALRefreshTokens)
					adminAdmin.POST("/mal/tokens/revoke", handlers.AdminMALRevokeTokens)
