...
func (_q *ScheduleQuery) QueryAnime() *AnimeQuery {
	query := (&AnimeClient{config: _q.config}).Query()
...
func (_q *ScheduleQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ScheduleQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ScheduleQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ScheduleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ScheduleQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ScheduleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ScheduleQuery) WithAnime(opts ...func(*AnimeQuery)) *ScheduleQuery {
	query := (&AnimeClient{config: _q.config}).Query()
...
func (_q *ScheduleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Schedule, error) {
	...
	if query := _q.withAnime; query != nil {
		if err := _q.loadAnime(ctx, query, nodes, nil,
			func(n *Schedule, e *Anime) { n.Edges.Anime = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ScheduleQuery) loadAnime(ctx context.Context, query *AnimeQuery, nodes []*Schedule, init func(*Schedule), assign func(*Schedule, *Anime)) error {
...
func (_q *ScheduleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAnime != nil {
			_spec.Node.AddColumnOnce(schedule.FieldAnimeID)
		}
	}
