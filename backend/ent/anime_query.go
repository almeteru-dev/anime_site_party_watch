...
func (_q *AnimeQuery) Where(ps ...predicate.Anime) *AnimeQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *AnimeQuery) Limit(limit int) *AnimeQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *AnimeQuery) Offset(offset int) *AnimeQuery {
...
func (_q *AnimeQuery) Unique(unique bool) *AnimeQuery {
...
func (_q *AnimeQuery) First(ctx context.Context) (*Anime, error) {
...
func (_q *AnimeQuery) FirstX(ctx context.Context) *Anime {
...
func (_q *AnimeQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AnimeQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *AnimeQuery) Only(ctx context.Context) (*Anime, error) {
...
func (_q *AnimeQuery) OnlyX(ctx context.Context) *Anime {
...
func (_q *AnimeQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AnimeQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *AnimeQuery) All(ctx context.Context) ([]*Anime, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*Anime, *AnimeQuery]()
	return withInterceptors[[]*Anime](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *AnimeQuery) AllX(ctx context.Context) []*Anime {
...
func (_q *AnimeQuery) IDs(ctx context.Context) (ids []int64, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(anime.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *AnimeQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AnimeQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*AnimeQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *AnimeQuery) CountX(ctx context.Context) int {
...
func (_q *AnimeQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *AnimeQuery) ExistX(ctx context.Context) bool {
...
func (_q *AnimeQuery) Clone() *AnimeQuery {
	if _q == nil {
		return nil
	}
	return &AnimeQuery{
...
func (_q *AnimeQuery) Select(fields ...string) *AnimeSelect {
	...
	sbuild := &AnimeSelect{AnimeQuery: _q}
...
func (_q *AnimeQuery) Aggregate(fns ...AggregateFunc) *AnimeSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *AnimeQuery) prepareQuery(ctx context.Context) error {
...
func (_q *AnimeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(anime.Table, anime.Columns, sqlgraph.NewFieldSpec(anime.FieldID, field.TypeInt64))
	_spec.From = _q.sql
...
func (_q *AnimeQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *AnimeGroupBy) Aggregate(fns ...AggregateFunc) *AnimeGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *AnimeGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*AnimeQuery, *AnimeGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *AnimeGroupBy) sqlScan(ctx context.Context, root *AnimeQuery, v any) error {
...
func (_s *AnimeSelect) Aggregate(fns ...AggregateFunc) *AnimeSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *AnimeSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*AnimeQuery, *AnimeSelect](ctx, _s.AnimeQuery, _s, _s.inters, v)
}

func (_s *AnimeSelect) sqlScan(ctx context.Context, root *AnimeQuery, v any) error {
